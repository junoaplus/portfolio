...
export default function ContactPage() {
  ...
  const collaborationTypes = [
    { icon: Briefcase, title: "풀타임 포지션", description: "정규직 AI 엔지니어 포지션" },
    { icon: Coffee, title: "프리랜스 프로젝트", description: "단기/중기 프로젝트 협업" },
    { icon: Github, title: "오픈소스 기여", description: "오픈소스 프로젝트 참여" },
    { icon: MessageCircle, title: "멘토링 & 교육", description: "기술 멘토링 및 교육 활동" },
  ]
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      ...
      <div className="pt-16">
        ...
        <div className="px-4 py-16 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">연락 방법</h2>
                ...
                >
                  <Card className="bg-white border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 group transform hover:-translate-y-2 h-full">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-blue-600 font-medium break-all">{method.value}</p>
                    </CardContent>
                  </Card>
                </a>
              ))}
        ...
        <div className="px-4 py-16 bg-gradient-to-br from-gray-50 to-blue-50/20">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">메시지 보내기</h2>
              <p className="text-gray-600">직접 메시지를 보내주시면 빠르게 답변드리겠습니다</p>
            </div>
            ...
            {!isSubmitted ? (
              ...
              <Card className="bg-white/80 backdrop-blur-sm border border-green-200 shadow-xl">
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-gray-900 mb-4">메시지가 전송되었습니다!</h3>
        ...
        <div className="px-4 py-16 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-gray-900 mb-4">협업 가능한 분야</h2>
