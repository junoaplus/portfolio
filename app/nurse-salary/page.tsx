        ...
        <div className="max-w-7xl mx-auto">
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm border border-gray-600/50 shadow-2xl mb-12">
            ...
            <CardContent>
              <p className="text-lg text-gray-300 leading-relaxed mb-8">
                <span className="font-bold text-gray-200">간호사 급여 예측</span>을 위한 머신러닝 회귀 모델 개발 프로젝트입니다. <span className="font-bold text-gray-200">체계적인 EDA를 통해 데이터 특성을 파악</span>하고, <span className="font-bold text-gray-200">4가지 회귀 알고리즘의 성능을 비교 분석</span>하여 최적의 예측 모델을 구축했습니다. <span className="font-bold text-gray-200">30% 오차 이내 정답률</span>이라는 실용적 지표로 모델 성능을 평가했으며, <span className="font-bold text-gray-200">피처 중요도 분석</span>을 통해 급여 결정 요인에 대한 인사이트를 도출했습니다.
              </p>
          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm border border-gray-600/50 shadow-2xl mb-12">
            ...
            <CardContent className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h4 className="text-white font-semibold mb-3">LogisticRegression 성능 향상</h4>
