          ...
          <Card className="bg-gray-800/80 backdrop-blur-sm border border-gray-600/50 shadow-2xl mb-12">
            ...
            <CardContent>
              <div className="text-lg text-gray-300 leading-relaxed space-y-4">
                <p>
                  <span className="font-bold text-cyan-400">수많은 의사결정 트리 중에 투표를 통해서 과반수가 이긴 쪽을 선택</span>하는 알고리즘입니다.
                </p>
                <p>
                  <span className="font-bold text-cyan-400">분류와 회귀 문제</span>에서 주로 사용하고, 
                  특히 Feature Importance로 어떤 변수가 중요한지 알 수 있어서 
                  <span className="font-bold text-cyan-400">해석하기 좋습니다.</span>
                </p>
                <p>
                  장점은 <span className="font-bold text-cyan-400">과적합이 잘 안 되고 안정적</span>이라는 것이고, 
                  단점은 <span className="font-bold text-cyan-400">트리가 많아지면 학습 시간이 오래 걸린다</span>는 것입니다.
                </p>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-blue-900/20 to-cyan-900/20 rounded-xl p-6 border border-blue-600/30 cursor-pointer hover:bg-gradient-to-r hover:from-blue-900/30 hover:to-cyan-900/30 transition-all duration-300" onClick={() => window.open('/newspaper-churn', '_blank')}>
                  ...
                  <div className="text-gray-300 space-y-3">
                    <p>
                      <span className="font-bold text-cyan-400">여러 의사결정 트리의 투표</span>로 
                      구독자 이탈을 예측했습니다. 
                ...
                <div className="bg-gradient-to-r from-green-900/20 to-teal-900/20 rounded-xl p-6 border border-green-600/30 cursor-pointer hover:bg-gradient-to-r hover:from-green-900/30 hover:to-teal-900/30 transition-all duration-300" onClick={() => window.open('/nurse-salary', '_blank')}>
                  ...
                  <div className="text-gray-300 space-y-3">
                    <p>
                      ...
                      <span className="font-bold text-cyan-400">Feature Importance로 어떤 변수가 중요한지</span> 
                      명확하게 파악할 수 있었습니다.
                    </p>
                  </div>
                </div>
              ...
              <div className="grid md:grid-cols-1 gap-6">
                ...
                <div className="bg-gradient-to-r from-blue-900/20 to-cyan-900/20 rounded-xl p-6 border border-blue-600/30">
                  ...
                  <div className="text-gray-300 space-y-2">
                    <div>• <span className="font-bold text-blue-400">문제:</span> 하나의 의사결정 트리는 과적합이 쉽게 발생</div>
                    <div>• <span className="font-bold text-blue-400">해결:</span> 여러 트리의 투표로 안정적인 예측</div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 rounded-xl p-6 border border-green-600/30">
                  ...
                  <div className="text-gray-300 space-y-2">
                    <div>• <span className="font-bold text-green-400">문제:</span> 어떤 변수가 예측에 중요한지 알기 어려움</div>
                    <div>• <span className="font-bold text-green-400">해결:</span> Feature Importance로 변수 중요도 명확하게 제시</div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-red-900/20 to-pink-900/20 rounded-xl p-6 border border-red-600/30">
                  ...
                  <div className="text-gray-300 space-y-2">
                    <div>• <span className="font-bold text-red-400">한계:</span> 트리가 많아지면 학습 시간이 오래 걸림</div>
                    <div>• <span className="font-bold text-red-400">고려사항:</span> 트리 개수와 성능의 균형점 찾기 필요</div>
                  </div>
                </div>
              </div>
            </CardContent>
