    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30">
      ...
      <div className="pt-16">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8">
              {filteredSkills.map((skill, index) => (
                <Link href={`/skills/${skill.name.toLowerCase().replace(/[^a-z0-9]/g, "-")}`} key={skill.name}>
                  <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-300 group overflow-hidden transform hover:-translate-y-1 cursor-pointer">
                    <CardContent className="p-6">
                      ...
                      {/* Projects */}
                      <div className="mb-4">
                        <h4 className="font-semibold text-sm mb-2 text-gray-900">관련 프로젝트</h4>
        ...
        <div className="px-4 py-20 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">학습 여정</h2>
              <p className="text-xl text-gray-600">기술 습득 과정과 성장 스토리</p>
            </div>
        ...
        <div className="px-4 py-20 bg-gradient-to-br from-gray-50 to-blue-50/20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold text-gray-900 mb-4">자격증 & 교육</h2>
              <p className="text-xl text-gray-600">완료한 교육과 진행 중인 학습</p>
            </div>
