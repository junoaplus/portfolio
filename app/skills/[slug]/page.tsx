...
const techData = {
  "multi-agent-systems": {
    ...
    achievements: ["복잡한 워크플로우 자동화", "에이전트 간 협업 최적화", "상태 관리 시스템 구축"],
    nextGoals: ["대규모 에이전트 시스템 구축", "성능 최적화", "실시간 협업 강화"],
    relatedProjects: [
      {
        id: 1,
        title: "AI 챗봇 포트폴리오",
        ...
        techUsage: ["에이전트 워크플로우 설계", "상태 관리", "에이전트 간 통신"],
      },
    ],
    learningPath: [
      { phase: "기초 학습", description: "LangGraph 기본 개념 이해", duration: "1개월" },
      { phase: "실습 프로젝트", description: "간단한 멀티 에이전트 시스템 구축", duration: "2개월" },
      { phase: "고도화", description: "복잡한 워크플로우 구현", duration: "진행 중" },
    ],
    resources: [
  ...
  "langgraph-orchestration": {
    ...
    achievements: ["상태 관리 최적화", "에이전트 협업 로직 구현", "워크플로우 시각화"],
    nextGoals: ["복잡한 비즈니스 로직 구현", "실시간 처리 최적화", "모니터링 시스템 구축"],
    relatedProjects: [
      {
        id: 1,
        title: "AI 챗봇 포트폴리오",
    ...
    learningPath: [
      { phase: "기본 그래프", description: "간단한 워크플로우 구축", duration: "2주" },
      { phase: "고급 패턴", description: "조건부 분기와 병렬 처리", duration: "1개월" },
      { phase: "프로덕션", description: "에러 핸들링과 모니터링", duration: "진행 중" },
    ],
    resources: [
  ...
  "next-js": {
    ...
    achievements: ["Lighthouse 90+ 점수", "성능 최적화", "SEO 최적화", "타입 안전성 확보"],
    nextGoals: ["Server Components 심화", "Edge Runtime 활용", "Streaming 최적화"],
    relatedProjects: [
      {
        id: 1,
        title: "AI 챗봇 포트폴리오",
        ...
        techUsage: ["App Router", "Server Components", "API Routes", "Middleware"],
      },
      {
        id: 2,
        title: "데이트 코스 추천 AI",
    ...
    learningPath: [
      ...
      { phase: "고급", description: "App Router와 Server Components", duration: "진행 중" },
    ],
    resources: [
  ...
  "langgraph": {
    ...
    experience: "1년+",
    description: "AI 에이전트 워크플로우 오케스트레이션 전문",
    longDescription: "LangGraph를 사용하여 복잡한 AI 워크플로우를 설계하고 관리합니다. 조건부 분기, 병렬 처리, 에러 핸들링 등을 포함한 견고한 AI 시스템을 구축할 수 있습니다.",
    achievements: ["상태 관리 최적화", "에이전트 협업 로직 구현", "워크플로우 시각화"],
    nextGoals: ["복잡한 비즈니스 로직 구현", "실시간 처리 최적화", "모니터링 시스템 구축"],
    relatedProjects: [{
      id: 1,
  ...
  "langchain": {
    ...
    longDescription: "LangChain을 활용하여 LLM 기반 애플리케이션을 구축합니다. 체인, 에이전트, 메모리 관리 등 다양한 컴포넌트를 조합하여 복잡한 AI 워크플로우를 만들 수 있습니다.",
    ...
    learningPath: [
      ...
      { phase: "고급", description: "복잡한 워크플로우 구축", duration: "진행 중" },
    ],
    resources: [
  ...
  "multi-agent": {
    ...
    longDescription: "여러 AI 에이전트가 협업하여 복잡한 작업을 수행하는 시스템을 구축합니다. 각 에이전트의 역할 분담, 통신 프로토콜, 협업 전략을 설계할 수 있습니다.",
    achievements: ["에이전트 협업 최적화", "역할 분담 설계", "통신 프로토콜 구현"],
    ...
    learningPath: [
      ...
      { phase: "구현", description: "간단한 멀티 에이전트 시스템", duration: "1개월" },
      { phase: "최적화", description: "성능 및 협업 최적화", duration: "진행 중" },
    ],
    resources: [
  ...
  "mcp": {
    ...
    longDescription: "MCP를 사용하여 AI 모델이 외부 도구와 데이터 소스에 안전하게 접근할 수 있는 시스템을 구축합니다. 표준화된 프로토콜을 통해 확장 가능한 AI 애플리케이션을 만들 수 있습니다.",
    ...
    learningPath: [
      ...
      { phase: "구현", description: "기본 서버/클라이언트 구축", duration: "3주" },
  ...
  "vector-db": {
    ...
    longDescription: "Supabase pgvector, Pinecone, Chroma 등 다양한 벡터 데이터베이스를 활용하여 임베딩 기반 검색 시스템을 구축합니다. 성능 최적화와 스케일링 전략을 수립할 수 있습니다.",
  ...
  "rag": {
    ...
    longDescription: "RAG 시스템을 통해 외부 지식을 활용한 AI 응답 생성 시스템을 구축합니다. 벡터 검색과 생성 모델을 결합하여 정확하고 신뢰할 수 있는 AI 서비스를 만들 수 있습니다.",
    achievements: ["95% 정확도 달성", "벡터 검색 최적화", "실시간 지식 업데이트"],
    ...
    learningPath: [
      ...
      { phase: "최적화", description: "성능 및 정확도 개선", duration: "진행 중" },
    ],
    resources: [
    ...
    skills: {
      ...
      supporting: ["Vector Databases", "Embedding Models", "Prompt Engineering"],
  ...
  "fastapi": {
    ...
    longDescription: "FastAPI를 사용하여 높은 성능의 RESTful API를 구축합니다. 자동 문서화, 타입 힌팅, 비동기 처리 등 현대적인 백엔드 개발 기법을 활용할 수 있습니다.",
    achievements: ["자동 문서화 구현", "비동기 처리 최적화", "타입 안전성 확보"],
  ...
  "supabase": {
    ...
    longDescription: "Supabase를 활용하여 백엔드 인프라를 구축합니다. PostgreSQL 기반의 실시간 데이터베이스, 인증, 스토리지 등을 통합적으로 관리할 수 있습니다.",
    achievements: ["실시간 데이터 동기화", "벡터 검색 구현", "인증 시스템 구축"],
  ...
  "typescript": {
    ...
    longDescription: "TypeScript를 활용하여 대규모 JavaScript 애플리케이션을 안전하고 효율적으로 개발합니다. 정적 타입 검사를 통해 런타임 에러를 방지하고 코드 품질을 향상시킬 수 있습니다.",
  ...
  "react": {
    ...
    longDescription: "React를 사용하여 복잡한 사용자 인터페이스를 구축합니다. 컴포넌트 기반 아키텍처, 상태 관리, 성능 최적화 등 현대적인 프론트엔드 개발을 수행할 수 있습니다.",
    achievements: ["재사용 가능한 컴포넌트 라이브러리", "성능 최적화", "상태 관리 시스템"],
  ...
  "nextjs": {
    ...
    longDescription: "Next.js를 사용하여 서버 사이드 렌더링, 정적 사이트 생성, API 라우트 등을 활용한 현대적인 웹 애플리케이션을 구축합니다. 성능 최적화와 SEO를 동시에 달성할 수 있습니다.",
  ...
  "tailwind": {
    ...
    longDescription: "Tailwind CSS를 사용하여 빠른 프로토타이핑과 일관된 디자인 시스템을 구축합니다. 유틸리티 클래스를 통해 효율적이고 유지보수 가능한 스타일링을 수행할 수 있습니다.",
    achievements: ["디자인 시스템 구축", "반응형 최적화", "개발 속도 향상"],
    nextGoals: ["커스텀 플러그인 개발", "디자인 토큰 시스템", "고급 애니메이션"],
    relatedProjects: [{
      id: 1,
      title: "AI 챗봇 포트폴리오",
  ...
  "docker": {
    ...
    longDescription: "Docker를 사용하여 애플리케이션을 컨테이너화하고 배포합니다. 개발, 테스트, 프로덕션 환경 간의 일관성을 보장하고 확장 가능한 인프라를 구축할 수 있습니다.",
  ...
  "vercel": {
    ...
    longDescription: "Vercel을 사용하여 프론트엔드 애플리케이션을 배포하고 관리합니다. 자동 배포, 성능 모니터링, Edge Functions 등을 활용하여 최적화된 웹 서비스를 제공할 수 있습니다.",
  ...
  "postgresql": {
    ...
    longDescription: "PostgreSQL을 사용하여 복잡한 데이터 모델링과 고성능 쿼리를 구현합니다. 고급 SQL 기능, 인덱싱, 트랜잭션 관리 등을 통해 안정적인 데이터베이스 시스템을 구축할 수 있습니다.",
  ...
  "python": {
    ...
    longDescription: "Python을 사용하여 백엔드 개발, 데이터 처리, AI/ML 모델 개발을 수행합니다. 풍부한 라이브러리 생태계를 활용하여 다양한 영역의 문제를 해결할 수 있습니다.",
  ...
  "github": {
    ...
    longDescription: "GitHub을 사용하여 코드 버전 관리, 협업, CI/CD 파이프라인을 구축합니다. Git 워크플로우, 코드 리뷰, 이슈 관리 등을 통해 효율적인 개발 프로세스를 운영할 수 있습니다.",
      ...
      <div className="pt-16">
        ...
        <div className="px-4 py-16 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative">
              ...
              <div className="flex items-center gap-6">
                ...
                <div>
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <Badge className="bg-gray-100 text-gray-700 border-gray-200">{getSkillLabel(skill.level)}</Badge>
                  </div>
                  <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-2">{skill.name}</h1>
                  <p className="text-xl text-gray-600">{skill.description}</p>
                </div>
              </div>

              <div className="lg:ml-auto text-center lg:text-right">
                <div className="text-5xl font-bold text-gray-900 mb-2">{skill.level}%</div>
            ...
            {/* Description */}
            <p className="text-lg text-gray-600 leading-relaxed max-w-4xl">{skill.longDescription}</p>
          </div>
        </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div>
                        ...
                        <Badge className="bg-blue-50 text-blue-700 border-blue-200 text-xs">{project.role}</Badge>
                      </div>
                    </div>

                    <div className="space-y-4">
                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-green-600">프로젝트 임팩트</h4>
                        <p className="text-gray-600 text-sm">{project.impact}</p>
                      </div>

                      <div>
                        <h4 className="font-semibold text-sm mb-2 text-purple-600">기술 활용</h4>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">핵심 기술</CardTitle>
                </CardHeader>
                <CardContent>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">지원 기술</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
              ...
              <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                <CardHeader>
                  <CardTitle className="text-lg text-gray-900">개발 도구</CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="space-y-2">
                    ...
                    <Card className="flex-1 bg-white border border-gray-200 shadow-lg">
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-2">
                          ...
                          <Badge className="bg-orange-50 text-orange-700 border-orange-200">{phase.duration}</Badge>
                        </div>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-center gap-3 mb-3">
                      ...
                      <div>
                        ...
                        <Badge className="bg-blue-50 text-blue-700 border-blue-200 text-xs">{resource.type}</Badge>
                      </div>
                    </div>
        ...
        <div className="px-4 py-16 bg-gradient-to-br from-gray-50 to-blue-50/20">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-8 text-lg leading-relaxed">
              {skill.name}에 대한 구체적인 경험이나 프로젝트 적용 사례가 궁금하시다면,
              <br />
              AI 챗봇에게 직접 질문해보세요!
            </p>
