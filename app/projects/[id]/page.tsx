...
const projects = [
  {
    ...
    tech: ["Next.js 14", "LangGraph", "RAG", "OpenAI", "Supabase", "TypeScript", "Tailwind CSS", "Vercel"],
    category: "AI/ML",
    status: "Live",
    ...
    challenges: [
      {
        ...
        description: "여러 AI 에이전트가 효율적으로 협업하여 사용자 질문을 처리하는 시스템 구축",
        solution: "LangGraph의 상태 관리 기능을 활용하여 에이전트 간 정보 공유 및 작업 분배 최적화",
      },
      {
        title: "대용량 벡터 데이터 실시간 검색",
        description: "GitHub 데이터를 벡터화하여 실시간으로 검색하는 성능 최적화",
        solution: "Supabase Vector와 임베딩 캐싱을 통해 검색 속도 3배 향상",
      },
      {
        title: "사용자 의도 파악 정확도",
        description: "다양한 질문 형태에 대한 정확한 의도 파악 및 적절한 답변 생성",
        solution: "Chain of Thought 기법과 Few-shot Learning으로 답변 품질 개선",
      },
    ],
    techDetails: [
      {
  ...
  },
  {
    ...
    image: "/placeholder.svg?height=400&width=800",
    tech: ["FastAPI", "React", "AI Agents", "PostgreSQL", "Redis", "Kakao API", "Python", "Docker"],
    category: "AI/ML",
    status: "Featured",
    ...
    challenges: [
      {
        title: "대용량 지리 데이터 처리",
        description: "서울시 전체 장소 데이터의 효율적인 저장 및 검색 시스템 구축",
        solution: "PostgreSQL의 PostGIS 확장과 공간 인덱싱으로 검색 성능 10배 향상",
      },
      {
        ...
        <div className="px-4 py-12 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative">
            ...
            <div className="mb-12">
              ...
              <h1 className="text-4xl lg:text-5xl font-bold mb-4 text-gray-900">{project.title}</h1>
              <p className="text-xl text-blue-600 font-medium mb-6">{project.subtitle}</p>
              <p className="text-lg text-gray-600 leading-relaxed max-w-4xl">{project.longDescription}</p>
            </div>
                    ...
                    <div className="space-y-6">
                      {project.challenges.map((challenge, index) => (
                        <div key={index} className="border-l-4 border-orange-500 pl-6">
                          ...
                          <p className="text-gray-600 mb-3 leading-relaxed">{challenge.description}</p>
                          <div className="bg-gradient-to-r from-blue-50 to-purple-50/30 p-4 rounded-lg">
                            <p className="text-sm text-gray-700">
                              <strong className="text-blue-600">해결 방법:</strong> {challenge.solution}
                            </p>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                      {project.techDetails.map((tech, index) => (
                        ...
                        >
                          ...
                          <p className="text-xs text-blue-600 font-medium">{tech.usage}</p>
                        </div>
                      ))}
                    </div>
                  </CardContent>
              ...
              <div className="space-y-6">
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold mb-4 text-gray-900">프로젝트 정보</h3>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold mb-4 text-gray-900">기술 스택</h3>
                ...
                <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg">
                  <CardContent className="p-6">
                    <h3 className="text-lg font-bold mb-4 text-gray-900">링크</h3>
