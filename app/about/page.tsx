...
export default function AboutPage() {
  ...
  const interests = [
    ...
    {
      category: '소프트 스킬',
      items: ['팀 커뮤니케이션', '문제 해결 능력', '빠른 적응력'],
    },
  ]
        ...
        <div className="px-4 py-20 bg-gradient-to-br from-white via-blue-50/30 to-purple-50/20 relative overflow-hidden">
          ...
          <div className="max-w-4xl mx-auto text-center relative">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              안녕하세요! 프론트엔드부터 AI까지, 기술의 경계를 넘나드는 개발자
              황준호입니다.
              <br />
              복잡한 문제를 AI로 해결하고, 사용자가 쉽게 사용할 수 있는
              인터페이스를 만드는 것이 저의 목표입니다.
            </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-gray-600 leading-relaxed">
                    기술로 사람들의 일상을 더 편리하게 만들고 싶다는 꿈에서
                    시작되었습니다. 복잡한 문제를 AI로 해결하는 과정에서 느끼는
                    성취감과, 사용자와 AI가 자연스럽게 소통하는 인터페이스를
                    구축할 때의 즐거움이 저를 이 길로 이끌었습니다.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="bg-white/80 backdrop-blur-sm border border-gray-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                ...
                <CardContent>
                  <p className="text-gray-600 leading-relaxed">
                    5년 후에는 AI 제품의 기술 리더가 되어 더 많은 혁신을 이끌고
                    싶습니다. 멀티 에이전트 시스템과 RAG 기술을 활용한 차세대 AI
                    서비스를 만들어, 사람과 AI가 협력하는 새로운 패러다임을
                    제시하고 싶습니다.
                  </p>
                </CardContent>
              </Card>
