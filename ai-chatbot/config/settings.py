...
"""
    ...
    def get_cover_letter_data(company: str) -> str:
        ...
        if company == "toss":
            ...
            return Config.get_dalpha_cover_letter()
        ...
        elif company == "onthelook":
            return Config.get_onthelook_cover_letter()
        else:
            return """=== 일반 자소서 데이터 ===
기술적 도전을 통한 문제 해결과 지속적 학습을 추구합니다."""
    ...
    def get_company_context(company: str) -> str:
        ...
        if company == "toss":
            ...
            return Config.get_dalpha_job_context()
        elif company == "mindlogic":
            ...
            return Config.get_onthelook_job_context()
        else:
